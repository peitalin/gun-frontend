...
import {
  GET_ORDERS_REFUNDED_CONNECTION,
...
const OrdersRefundedList = (props: ReactProps) => {
        ...
        >
          ...
          >
            {({ node: order, key }) => {
              ...
              return (
                <RefundOrderRow key={key} order={order}/>
              )
            }}
...
export default withStyles(styles)( OrdersRefundedList );
