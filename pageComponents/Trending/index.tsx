  ...
  return (
    ...
    >
      ...
      <BannerTrending
        ...
        subheadingMobile={"List your gun for sale"}
        link={'/sell'}
      ...
      <div style={{
        ...
        <BannerTrending
          ...
          headingMobile={"Buy a promotion"}
          subheadingDesktop={"Promote listings on the news feed"}
          subheadingMobile={"Promote listings on the news feed"}
          link={'/promotions'}
          buttonText={"Go Now"}
        />
      </div>
