  ...
  return (
    <Card className={classes.card}>
      <CardActionArea
        ...
        classes={{
          root: (lgDown || !lgUp) ? classes.cardMediaWideLgDown : classes.cardMediaWide
        }}
      >
        {
          ...
          ? <CardMedia
              component="img"
              classes={{
                media: (lgDown || !lgUp) ? classes.cardMediaWideLgDown : classes.cardMediaWide
              }}
