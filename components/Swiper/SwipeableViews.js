...
class SwipeableViews extends React.Component {
  ...
  //   if (typeof index === 'number' && index !== nextProps.index) {
  //     if (process.env.NODE_ENV !== 'production') {
  ...
  //       // displaySameSlide: getDisplaySameSlide(nextProps, nextProps),
  //       displaySameSlide: false,
  //       indexLatest: index,
  //     }
  //   }
...
SwipeableViews.defaultProps = {
  ...
  springConfig: {
    ...
    // easeFunction: 'cubic-bezier(0.61, 1, 0.88, 1)', // ease-out
    // easeFunction: 'cubic-bezier(0, 0, 1, 1)', // linear
    easeFunction: 'cubic-bezier(0.25, 1, 0.5, 1)', // ease-out quart
    // easeFunction: 'cubic-bezier(0.3, 0.5, 0.5, 1)', // fast ease-in
    delay: '0s',
  },
  resistance: false,
};
