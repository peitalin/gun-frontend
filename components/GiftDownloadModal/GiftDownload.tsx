...
const GiftDownloadPage: React.FC<ReactProps> = (props) => {

  const { classes } = props;
  const [shareEmails, setShareEmails] = React.useState(["rachel@gmail.com"]);
...
export default withStyles(styles)( GiftDownloadPage );