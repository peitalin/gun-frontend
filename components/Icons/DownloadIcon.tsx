...
const DownloadIcon = ({ height, color, className }: ReactProps) => (
  ...
  >
    <g>
      <path fill={ color || "#FFFFFF" }
        d="M20.187,28.313c-0.391-0.391-1.023-0.391-1.414,0s-0.391,1.023,0,1.414l9.979,9.979C28.938,39.895,29.192,40,29.458,40
