...
const VerifyPhoneBanner: React.FC<ReactProps> = (props) => {
...

      {
        ...
        >
          ...
          <span className={classes.betaTestBannerText}>
            Confirm your phone number so buyers can contact you more easily<br/>
            <a href={"/settings"}
...
export default withStyles(styles)(VerifyPhoneBanner);
